...
# SJVA3 install for linuxdeploy_ubuntu_bionic
...
echo "(Step7) php7.2 install.."
apt -y install php7.2 php7.2-fpm php7.2-soap php7.2-gmp php7.2-json php7.2-zip php7.2-sqlite3 php7.2-xml php7.2-common php7.2-mysql php7.2-xmlrpc php7.2-bz2 php7.2-gd php7.2-bcmath php7.2-gd php7.2-odbc php7.2-curl php7.2-mbstring php7.2-apcu
...
apt -y remove python3-yaml
curl -LO https://raw.githubusercontent.com/jassmusic/termux/master/linuxdeploy_ubuntu_bionic_requirements.txt
pip3 install --no-cache-dir -r linuxdeploy_ubuntu_bionic_requirements.txt

# redis setting
sed -i "s/port 6379/port 46379/g" /etc/redis/redis.conf
update-rc.d redis-server defaults

# celery daemon setting
